...
<body>
	...
	<div id="login2-container">
		...
		<form name="frmContato" action="insert">
			...
			<label for="text">Nome</label> <input type="text" name="nome"
				id="nome" placeholder="Inserir o nome" autocomplete="off"> <label
				for="text">Telefone</label> <input type="text" name="fone" id="fone"
				placeholder="Inserir o telefone" autocomplete="off"> <label
				for="text">Email</label> <input type="text" name="email" id="email"
				placeholder="Inserir o email" autocomplete="off"> <label
				for="text">Senha</label> <input type="text" name="senha" id="senha"
				placeholder="Inserir a senha" autocomplete="off"> <input
				src="" type="submit" onclick="return validarNovoUsuario()">
		</form>
